...
CREATE TABLE "public"."admin_account" ("id" bigint NOT NULL, "username" character varying(32) NOT NULL, "password" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "status" smallint NOT NULL DEFAULT 0, "enable_mfa" boolean NOT NULL DEFAULT false, "mfa_secret" character varying(255) NULL, "created_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" timestamp NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY ("id"), CONSTRAINT "admin_account_email_key" UNIQUE ("email"), CONSTRAINT "admin_account_username_key" UNIQUE ("username"));
...
CREATE TABLE "public"."admin_refresh_token" ("id" bigint NOT NULL, "account_id" bigint NOT NULL, "device_id" character varying(64) NOT NULL, "issues_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, "expires_at" timestamp NOT NULL, "revoked" boolean NOT NULL DEFAULT false, "token" character varying(64) NOT NULL, "device_info" character varying(255) NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "admin_refresh_token_token_key" UNIQUE ("token"), CONSTRAINT "admin_refresh_token_account_id_fkey" FOREIGN KEY ("account_id") REFERENCES "public"."admin_account" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
...
CREATE TABLE "public"."publisher" ("id" bigint NOT NULL, "name" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "phone" character varying(15) NOT NULL, "status" smallint NOT NULL, "logo_url" character varying(255) NULL, "created_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY ("id"), CONSTRAINT "publisher_email_key" UNIQUE ("email"), CONSTRAINT "publisher_name_key" UNIQUE ("name"));
-- Create "game" table
CREATE TABLE "public"."game" ("id" bigint NOT NULL, "publisher_id" bigint NOT NULL, "name" character varying(255) NOT NULL, "price" numeric(13,2) NOT NULL, "status" integer NOT NULL, "release_date" timestamp NOT NULL, "created_at" timestamp NOT NULL, "updated_at" timestamp NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "game_publisher_id_fkey" FOREIGN KEY ("publisher_id") REFERENCES "public"."publisher" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
...
CREATE TABLE "public"."game_genre" ("game_id" bigint NOT NULL, "genre_id" bigint NOT NULL, PRIMARY KEY ("game_id", "genre_id"), CONSTRAINT "game_genre_game_id_fkey" FOREIGN KEY ("game_id") REFERENCES "public"."game" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION, CONSTRAINT "game_genre_genre_id_fkey" FOREIGN KEY ("genre_id") REFERENCES "public"."genre" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
...
CREATE TABLE "public"."game_tag" ("game_id" bigint NOT NULL, "tag_id" bigint NOT NULL, PRIMARY KEY ("game_id", "tag_id"), CONSTRAINT "game_tag_game_id_fkey" FOREIGN KEY ("game_id") REFERENCES "public"."game" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION, CONSTRAINT "game_tag_tag_id_fkey" FOREIGN KEY ("tag_id") REFERENCES "public"."tag" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
...
CREATE TABLE "public"."game_version" ("id" bigint NOT NULL, "game_id" bigint NOT NULL, "name" character varying(255) NOT NULL, "change_log" text NULL, "exec_path" character varying(255) NOT NULL, "download_url" character varying(255) NOT NULL, "status" integer NOT NULL, "release_date" timestamp NOT NULL, "created_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY ("id"), CONSTRAINT "game_version_game_id_fkey" FOREIGN KEY ("game_id") REFERENCES "public"."game" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
...
CREATE TABLE "public"."publisher_account" ("id" bigint NOT NULL, "publisher_id" bigint NOT NULL, "username" character varying(32) NOT NULL, "password" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "status" smallint NOT NULL DEFAULT 0, "enable_mfa" boolean NOT NULL DEFAULT false, "mfa_secret" character varying(255) NULL, "created_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" timestamp NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY ("id"), CONSTRAINT "publisher_account_email_key" UNIQUE ("email"), CONSTRAINT "publisher_account_username_key" UNIQUE ("username"), CONSTRAINT "publisher_account_publisher_id_fkey" FOREIGN KEY ("publisher_id") REFERENCES "public"."publisher" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
...
CREATE TABLE "public"."publisher_role" ("id" bigint NOT NULL, "publisher_id" bigint NULL, "name" character varying(255) NOT NULL, "active" boolean NOT NULL DEFAULT true, "description" character varying(255) NULL, "updated_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY ("id"), CONSTRAINT "publisher_role_publisher_id_fkey" FOREIGN KEY ("publisher_id") REFERENCES "public"."publisher" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
...
CREATE TABLE "public"."publisher_account_role" ("publisher_account_id" bigint NOT NULL, "publisher_role_id" bigint NOT NULL, PRIMARY KEY ("publisher_account_id", "publisher_role_id"), CONSTRAINT "publisher_account_role_publisher_account_id_fkey" FOREIGN KEY ("publisher_account_id") REFERENCES "public"."publisher_account" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION, CONSTRAINT "publisher_account_role_publisher_role_id_fkey" FOREIGN KEY ("publisher_role_id") REFERENCES "public"."publisher_role" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
...
CREATE TABLE "public"."publisher_refresh_token" ("id" bigint NOT NULL, "account_id" bigint NOT NULL, "device_id" character varying(64) NOT NULL, "issues_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, "expires_at" timestamp NOT NULL, "revoked" boolean NOT NULL DEFAULT false, "token" character varying(64) NOT NULL, "device_info" character varying(255) NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "publisher_refresh_token_token_key" UNIQUE ("token"), CONSTRAINT "publisher_refresh_token_account_id_fkey" FOREIGN KEY ("account_id") REFERENCES "public"."publisher_account" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
...
CREATE TABLE "public"."user_account" ("id" bigint NOT NULL, "username" character varying(32) NOT NULL, "password" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "status" smallint NOT NULL DEFAULT 0, "enable_mfa" boolean NOT NULL DEFAULT false, "mfa_secret" character varying(255) NULL, "created_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" timestamp NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY ("id"), CONSTRAINT "user_account_email_key" UNIQUE ("email"), CONSTRAINT "user_account_username_key" UNIQUE ("username"));
...
CREATE TABLE "public"."user_oauth2_account" ("id" bigint NOT NULL, "oauth2_id" character varying(255) NOT NULL, "oauth2_provider" character varying(255) NOT NULL, "status" smallint NOT NULL, "user_account_id" bigint NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "user_oauth2_account_user_account_id_fkey" FOREIGN KEY ("user_account_id") REFERENCES "public"."user_account" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
...
CREATE TABLE "public"."user_refresh_token" ("id" bigint NOT NULL, "account_id" bigint NOT NULL, "device_id" character varying(64) NOT NULL, "issues_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, "expires_at" timestamp NOT NULL, "revoked" boolean NOT NULL DEFAULT false, "token" character varying(64) NOT NULL, "device_info" character varying(255) NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "user_refresh_token_token_key" UNIQUE ("token"), CONSTRAINT "user_refresh_token_account_id_fkey" FOREIGN KEY ("account_id") REFERENCES "public"."user_account" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
